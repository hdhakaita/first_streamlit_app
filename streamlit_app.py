...
streamlit.header('json data to table format ')
...
#create repeatale code block called function
...
streamlit.header('Hemendra: Fruityvice Fruit Advice!')
try: 
...
add_my_fruit = streamlit.text_input('What fruit whould you loke to add?') 
...
#adding fruit choice
streamlit.header('What Fruit you would loke to add?')
